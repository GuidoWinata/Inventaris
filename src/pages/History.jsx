...
import CompntTnggt from '../components/kartu/CompntTnggt';
...
export default function History() {
  ...
  const itemsPerPage = 8; // Jumlah kartu per halaman
  const totalCards = 30; // Gantikan dengan jumlah data asli Anda
  const usersCards = useMemo(() => new Array(totalCards).fill({ id: Math.random(), component: <CompntTnggt /> }), [totalCards]); // Gantikan dengan data asli Anda
